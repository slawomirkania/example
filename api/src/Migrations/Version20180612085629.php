 ...
 */
final class Version20180612085629 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT NOT NULL, username VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT \'false\' NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE role_account DROP CONSTRAINT FK_C1FBF35F9B6B5FBA');
